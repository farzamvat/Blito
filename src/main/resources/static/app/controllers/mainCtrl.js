        ...
        $rootScope.$on("$locationChangeStart", function(event, next, current) {
            ...
            switch ($location.path()) {
                case '/':
                    ...
                    $rootScope.keyWord = 'برنامه تفریحی تهران، کنسرت‌های تهران، کنسرت‌های تهران ۹۶، کنسرت‌های این ماه، کنسرت‌های این هفته، کنسرت‌های امروز، مکان‌های تفریحی تهران، کنسرت راک تهران، مکان‌های دیدنی تهران، کارگاه‌ آموزشی فیلم سازی';
                ...
                case '/entertainment' :
                    ...
                    $rootScope.keyWord = 'مکان‌های تفریحی و سرگرمی، مکان‌های تفریحی اطراف تهران، برنامه سرگرمی و تفریحی تهران، کافه برد، برد بازی، برد گیم';
                    $rootScope.robotValue = 'index';
                    break;
                case '/exhibition' :
                    ...
                    $rootScope.keyWord = 'مکان‌های تفریحی و سرگرمی، نمایشگاه‌های تهران، نمایشگاه هنری، نمایشگاه آثار هنری، نمایشگاه نقاشی، مکان‌های هنری و فرهنگی';
                    $rootScope.robotValue = 'index';
                    break;
                case '/tour' :
                    $rootScope.title = 'تور';
                    ...
                    $rootScope.keyWord = 'تور‌های ایران، تور‌های تفریحی، بلیط تور‌های ایران، تور شیراز، تور کویر، تور شمال، تور جنگل، تور‌های تفریحی جنگل، تور کویر مرنجاب، تور کویر مصر، تور کویر متین آباد، تور جنگل ابر، تور دریاچه چورت، تور قلعه الموت';
                    $rootScope.robotValue = 'index';
                    break;
                case '/theater' :
                    ...
                    $rootScope.keyWord = 'بلیط تئاتر شهر، بلیط تئاتر کمدی، بلیط تئاتر تهران، تئاتر تهران، تئاتر‌های این هفته، تئاتر‌های امروز تهران، تئاتر‌ این ماه';
                    $rootScope.robotValue = 'index';
                    break;
                case '/concert' :
                    ...
                    $rootScope.keyWord = 'کنسرت‌های تهران، کنسرت‌های جدید در تهران، کنسرت‌های تهران ۹۶، کنسرت‌های امروز تهران، کنسرت‌های این ماه، کنسرت‌های این هفته، کنسرت‌های راک تهران، بلیط کنسرت تهران';
                    $rootScope.robotValue = 'index';
                    break;
                case '/cinema' :
                    ...
                    $rootScope.keyWord = 'اکران فیلم کوتاه، فیلم‌های هالیوود، فیلم ترسناک، اکران فیلم‌های جدید، فیلم‌های جدید، نقد فیلم‌های جدید، اکران فیلم در تهران';
                    $rootScope.robotValue = 'index';
                    break;
                case '/workshop' :
                    ...
                    $rootScope.keyWord = 'اموزش فیلمسازی، کارگاه سینما، آموزش نقاشی، کارگاه موسیقی، کارگاه آموزش فیلمسازی، کارگاه آموزش موسیقی';
                    $rootScope.robotValue = 'index';
                    break;
                case '/other' :
                    ...
                    $rootScope.keyWord = 'رویداد‌های فرهنگی و هنری، سرگرمی و تفریحی، بلیط کنسرت، بلیط تئاتر، بلیط سرگرمی و تفریحی';
                    $rootScope.robotValue = 'index';
                    break;
                case '/exchange-tickets' :
                    ...
                    $rootScope.keyWord = 'آگهی بلیط، آگهی بلیت، بلیط کنسرت تهران، بلیط تئاتر تهران، بلیط کنسرت، آگهی بلیط کنسرت، آگهی بلیط تئاتر';
                    $rootScope.robotValue = 'index';
                    break;
                case '/activate-user' :
