...
public class ReferencePaymentLocator extends org.apache.axis.client.Service implements com.blito.payments.saman.webservice.client.ReferencePayment {
    ...
    public ReferencePaymentLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }
    ...
    public com.blito.payments.saman.webservice.client.ReferencePaymentSoap getPaymentIFBindingSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.blito.payments.saman.webservice.client.ReferencePaymentSoap getPaymentIFBindingSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.blito.payments.saman.webservice.client.ReferencePaymentSoapStub _stub = new com.blito.payments.saman.webservice.client.ReferencePaymentSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.blito.payments.saman.webservice.client.ReferencePaymentSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.blito.payments.saman.webservice.client.ReferencePaymentSoapStub _stub = new com.blito.payments.saman.webservice.client.ReferencePaymentSoapStub(new java.net.URL(PaymentIFBindingSoap_address), this);
                _stub.setPortName(getPaymentIFBindingSoapWSDDServiceName());
                return _stub;
            }
        }
