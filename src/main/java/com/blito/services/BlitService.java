...
//import com.blito.services.blit.AbstractBlitService;
...
//
//@Service
//public class BlitService extends AbstractBlitService<CommonBlit,CommonBlitViewModel> {
...
//	@Transactional
//	@Override
//	protected Object createBlitAuthorized(CommonBlitViewModel viewModel, User user) {
...
//	@Transactional
//	@Override
//	protected CommonBlitViewModel reserveFreeBlitForAuthorizedUser(BlitType blitType, CommonBlit commonBlit, User user) {
//		if (commonBlit.getCount() > 10)
//			throw new NotAllowedException(ResourceUtil.getMessage(Response.BLIT_COUNT_EXCEEDS_LIMIT));
//		// TODO: 10/16/17 bug needs test
//		if (commonBlit.getCount() + commonBlitRepository.sumCountBlitByEmailAndBlitTypeId(user.getEmail(),
...
//	@Transactional
//	@Override
//	protected PaymentRequestViewModel createUnauthorizedAndNoneFreeBlits(CommonBlitViewModel viewModel) {
