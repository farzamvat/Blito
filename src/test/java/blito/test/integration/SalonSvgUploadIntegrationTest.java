...
public class SalonSvgUploadIntegrationTest extends AbstractRestControllerTest {
    ...
    public void uploadSalonAndSectionsSvg_success() {
        ...
        salonViewModel.setSalonSvg("<?xml version=\"1.0\" encoding=\"utf-8\"?>\n" +
                ...
                "</g>\n" +
                "<g>\n" +
                "  <path fill=\"#808285\" d=\"M1002.828,253.781c534.777,0,970.429-112.802,988.657-253.781H14.17\n" +
                "    C32.399,140.979,468.051,253.781,1002.828,253.781z\"/>\n" +
                "</g>\n" +
                "<text transform=\"matrix(1.098 0 0 1 894.2695 125.0083)\" fill=\"#F1F2F2\" font-family=\"'Ordibehesht-bold'\" font-size=\"61.1458\">\n" +
                "ارجا هنحص</text>\n" +
                "</svg>");
        salonViewModel.getSections().forEach(sectionViewModel -> sectionViewModel.setSectionSvg(salonViewModel.getSalonSvg()));

        givenRestIntegration()
                .body(salonViewModel)
                .when()
                .put(getServerAddress() + "/api/blito/v1.0/salons/upload-svg")
                .then().statusCode(200);
    }
}
